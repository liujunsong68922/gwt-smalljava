...
import com.smalljava.core.analyse.l4_block.plugin.BracePlugin;
import com.smalljava.core.analyse.l4_block.plugin.DowhilePlugin;
import com.smalljava.core.analyse.l4_block.plugin.ForLoopPlugin;
import com.smalljava.core.analyse.l4_block.plugin.IAnalysePlugin;
import com.smalljava.core.analyse.l4_block.plugin.IfPlugin;
import com.smalljava.core.analyse.l4_block.plugin.ImportPlugin;
import com.smalljava.core.analyse.l4_block.plugin.MultiLineMemoPlugin;
import com.smalljava.core.analyse.l4_block.plugin.ReturnPlugin;
import com.smalljava.core.analyse.l4_block.plugin.SemicolonPlugin;
import com.smalljava.core.analyse.l4_block.plugin.SingleLineMemoPlugin;
import com.smalljava.core.analyse.l4_block.plugin.WhiledoPlugin;
