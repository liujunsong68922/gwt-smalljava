 ...
 *
 */
public class SmallJavaFileSingleLineMemoPlugin implements ISmallJavaFileAnalysePlugin {
	private Logger logger = LoggerFactory.getLogger(SmallJavaFileSingleLineMemoPlugin.class);
