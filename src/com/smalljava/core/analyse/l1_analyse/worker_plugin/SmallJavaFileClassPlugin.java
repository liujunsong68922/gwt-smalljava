...
public class SmallJavaFileClassPlugin implements ISmallJavaFileAnalysePlugin {
	private Logger logger = LoggerFactory.getLogger(SmallJavaFileClassPlugin.class);
