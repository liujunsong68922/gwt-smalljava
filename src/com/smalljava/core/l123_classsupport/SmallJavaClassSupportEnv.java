package com.smalljava.core.l123_classsupport;

import java.util.HashMap;

import com.smalljava.core.l123_classsupport.helper.SmallJavaClassManager;
import com.smalljava.core.l123_classsupport.helper.SmallJavaClassSupportEnv_ClassLoader;
import com.smalljava.core.l123_classsupport.helper.SmallJavaClassSupportEnv_NewInstance;
import com.smalljava.core.l123_classsupport.helper.SmallJavaObjectManager;
...
public class SmallJavaClassSupportEnv {
	...
	public boolean loadClassDefineString(String strClassDefine) {
		...
		return classloader.loadClassDefineString(this.getClassmanager(), strClassDefine);
	}
	...
	public JavaClassInstanceVO newInstance(String classname) {
		...
		JavaClassInstanceVO instancevo = newinstance.newInstance(this, classname);
		if(instancevo !=null) {
