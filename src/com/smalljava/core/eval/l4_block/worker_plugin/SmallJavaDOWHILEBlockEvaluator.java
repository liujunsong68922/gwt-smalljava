...
public class SmallJavaDOWHILEBlockEvaluator {
	private Logger logger = LoggerFactory.getLogger(SmallJavaDOWHILEBlockEvaluator.class);
	...
	public boolean execute(DOWHILEBlock block,L4_HashMapBlockVarTableImpl vartable,
		...
		//
		SmallJavaBlockEvaluator blockevalutor = new SmallJavaBlockEvaluator();
