...
import com.smalljava.core.eval.l5_expression.worker_plugin.atom.AtomEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.constvalue.ConstEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.one.LogicNotPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.oop.ImportExpressionPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.oop.NewOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.oop.ObjectCallEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.two.LogicAndOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.two.LogicEqualsOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.two.LogicGreaterEqualOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.two.LogicGreaterOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.two.LogicLitterEqualOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.two.LogicLitterOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.two.LogicNotEqualOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.two.LogicOrOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.two.MathAddOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.two.MathDeAddOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.two.MathDevideOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.two.MathMultiOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.var.DefineOperEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.var.VarSetEvalPlugin;
import com.smalljava.core.eval.l5_expression.worker_plugin.var.VariableEvalPlugin;
...
public class SmallJavaExpressionEval implements ISmallJavaExpressionEval {
	private Logger logger = LoggerFactory.getLogger(SmallJavaExpressionEval.class);

	private static HashMap<String, ISmallJavaExpressionEval> evalmap = new HashMap<String, ISmallJavaExpressionEval>();
	...
	public VarValue eval(RootAST root, 
		...
		if (root instanceof DualOperDataOperElement) {
			...
			ISmallJavaExpressionEval eeval = this.getEvalPluginByOpercode(oper.getOpercode());
			if (eeval == null) {
	...
	private ISmallJavaExpressionEval getEvalPluginByOpercode(String opercode) {
		initEvalMap();
