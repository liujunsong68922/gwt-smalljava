package com.smalljava.core.l6_oopsupport.newinstance;
...
import com.smalljava.core.l6_oopsupport.newinstance.gwtuiplugin.GwtAbsolutePanelNewInstance;
import com.smalljava.core.l6_oopsupport.newinstance.gwtuiplugin.GwtButtonNewInstance;
import com.smalljava.core.l6_oopsupport.newinstance.gwtuiplugin.GwtHtmlNewInstance;
import com.smalljava.core.l6_oopsupport.newinstance.gwtuiplugin.GwtImageNewInstance;
import com.smalljava.core.l6_oopsupport.newinstance.gwtuiplugin.GwtLabelNewInstance;
import com.smalljava.core.l6_oopsupport.newinstance.gwtuiplugin.GwtTextAreaNewInstance;
import com.smalljava.core.l6_oopsupport.newinstance.gwtuiplugin.GwtTextBoxNewInstance;
import com.smalljava.core.l6_oopsupport.newinstance.javaplugin.ArrayListNewInstance;
import com.smalljava.core.l6_oopsupport.newinstance.javaplugin.BitSetNewInstance;
import com.smalljava.core.l6_oopsupport.newinstance.javaplugin.DateNewInstance;
import com.smalljava.core.l6_oopsupport.newinstance.javaplugin.HashMapNewInstance;
import com.smalljava.core.l6_oopsupport.newinstance.javaplugin.HashSetNewInstance;
...
public class NewInstancePluginManager implements INewInstance {
	...
	public static HashMap<String, INewInstance> getInstancemap() {
		return instancemap;
	}

	public static void setInstancemap(HashMap<String, INewInstance> instancemap) {
		NewInstancePluginManager.instancemap = instancemap;
	}
